...
if (anythingIwant === 'paper') return 'Papier';
if (anythingIwant === 'scissors') return 'Schere';
return 'Stein';
}
...
result_div.innerHTML = `<p>${convertCase(user)}${userName} schlägt ${convertCase(computer)}${compName}. Du gewinnst!</p>`;
...
const userName = ' (user)'.fontsize(3).sup();
const compName = ' (comp)'.fontsize(3).sup();
result_div.innerHTML = `<p>${convertCase(computer)}${compName} schlägt ${convertCase(user)}${userName}. Du verlierst!</p>`;
const roundStatus = document.getElementById(user);
...
const userName = ' (user)'.fontsize(3).sup();
const compName = ' (comp)'.fontsize(3).sup();
result_div.innerHTML = `<p>Unentschieden! Ihr habt beide ${convertCase(user)} gewählt</p>`;
